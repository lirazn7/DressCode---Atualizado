      ...
      >
        ...
        <View style={styles.contentOverlay}>
          ...
          <View style={styles.interactionPanel}>
            <TouchableOpacity style={[styles.iconButton, styles.clickable]} onPress={() => handleLike(item.id)}>
            ...
            <TouchableOpacity style={[styles.iconButton, styles.clickable]} onPress={() => handleOpenComments(item.id)}>
              <MaterialCommunityIcons name="chat-outline" size={30} color="#e5e2e1" />
              <Text style={styles.iconText}>{item.comments_count || '0'}</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.iconButton, styles.clickable]}>
    ...
    <View style={styles.outerContainer}>
      ...
      <View style={styles.responsiveContainer}>
        ...
        <FlatList
          ...
          pagingEnabled={Platform.OS !== 'web'} // Desativa paging travado no PC para scroll suave com scrollbar/wheel
...
const styles = StyleSheet.create({
  ...
  topBar: { position: 'absolute', top: 0, left: 0, right: 0, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingTop: Platform.OS === 'ios' ? 50 : 35, paddingBottom: 15, zIndex: 10, backgroundColor: 'rgba(19, 19, 19, 0.75)' },
  headerTitle: { color: '#e5e2e1', fontSize: 20, letterSpacing: 4, fontWeight: 'bold', fontStyle: 'italic' },
  bottomNavContainer: { position: 'absolute', bottom: 20, left: 0, right: 0, alignItems: 'center', zIndex: 10 },
  bottomNav: { flexDirection: 'row', width: '92%', height: 65, backgroundColor: 'rgba(22, 13, 34, 0.95)', borderRadius: 35, alignItems: 'center', justifyContent: 'space-around', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', paddingHorizontal: 10 },
  centerAddBtn: { marginTop: -30 },
  addBtnGradient: { width: 56, height: 56, borderRadius: 28, justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#131313' },
  ...
  commentOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end', alignItems: 'center' },
  commentContent: { width: '100%', maxWidth: 480, height: '60%', backgroundColor: '#1c1b1b', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20 },
  ...
  input: { flex: 1, color: '#e5e2e1', backgroundColor: '#2a2a2a', borderRadius: 25, paddingHorizontal: 20, height: 46, outlineStyle: 'none' },
